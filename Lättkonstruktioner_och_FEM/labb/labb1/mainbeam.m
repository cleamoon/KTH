...
G=E/2/(1+0.3);	% Shear modulus [N/m2]
I=7000/1e12;	% Moment of inertia about x-axis [m4]
J=3.733333333333333e+02/1e12;	% Torsional constant [m4]
EI=E*I;		% Bending stiffness [Nm2]
GJ=G*J;		% Torsional stiffness [Nm2]
I0=1.038933333333333e+05/1e12;	% Polar moment of inertia [m4]
A=154e-6;	% Cross-section area [m2]
...
% and present results
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[defl,teta,fi,wmax,tmax,fimax,R,W]=bending(Ks,Qs,K,Q,nnode,node_z);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[pb,ub]=buckle2(Ks,Ksigmas,nnode,node_z,nelem,le);
