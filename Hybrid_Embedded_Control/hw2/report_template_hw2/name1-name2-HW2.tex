...
\begin{itemize}
\item The final .pdf file that you submit in Bilda needs to have the form name1-name2-HW2.pdf where name1, name2 are the surnames of the two authors of the Homework.
