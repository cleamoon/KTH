...
namespace
{
    ...
    */
                                     ...
                                     const float t)
    {
		...
		ColorSpace::Rgb ColorDiff;
		ColorDiff.r = ColorB.r - ColorA.r;
		ColorDiff.g = ColorB.g - ColorA.g;
		ColorDiff.b = ColorB.b - ColorA.b;

        InterpolatedColor.r = ColorA.r + ColorDiff.r * t;
        InterpolatedColor.g = ColorA.g + ColorDiff.g * t;
        InterpolatedColor.b = ColorA.b + ColorDiff.b * t;
