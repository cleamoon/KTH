...
dydt(1)=(1/y(5))*(g0*isp1*max_propellant_mass_1/tb1-0.5*density(y(4))*y(1)^2*A*cd-y(5)*sin(y(2))*(mu/(R_earth+y(4))^2-(y(1)*cos(y(2)))^2/(R_earth+y(4))));
