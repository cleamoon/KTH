public class Fysiker extends Human implements Comparable<Human> {
    ...
    private Fysiker(int ageIn, String nameIn, int yearIn) {
		super(ageIn, nameIn);
	...
	private Fysiker() {
        super();
        new Fysiker(slumpFysikerAge(year), slumpName(), slumpYear());
    }

    public static Fysiker init(int age, String name, int year) {
	    return new Fysiker(age, name, year);
    }
